  ...
  <section>
    <div className={tw(`w-full min-h-screen bg-gray-900 relative`)}>
      ...
      <div className={tw(`max-w-7xl mx-4 lg:mx-auto pt-20 lg:pt-40`)}>
        <h1 className={tw(`text-white text-4xl lg:text-7xl font-bold text-center`)}>See live/upcoming events</h1>
        <p className={tw(`text-white text-gray-400 text-center text-xl mt-12`)}>Peek what NEAR-meetups is upto...</p>
            ...
            {articles.map((article) => (
              ...
              >
                ...
                <div className={tw(`p-4 shadow-lg w-full mx-auto -mt-8 bg-white rounded-b z-30 relative`)}>
                  <p className={tw(`uppercase text-sm text-gray-700 text-center pb-1`)}>Upcoming event</p>
